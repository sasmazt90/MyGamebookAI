...
const en: Translations = {
  ...
  "footer.contact": "Contact: support@ai-gamebook.store",
  ...
  "footer.copyright": "© 2026 AI GAMEBOOKS STORE by SASMAZ DIGITAL SERVICES. All rights reserved.",
  // Legal titles
...
const de: Partial<Translations> = {
  ...
  "footer.contact": "Kontakt: support@ai-gamebook.store",
  "footer.impressum": "Impressum",
  ...
  "footer.copyright": "© 2026 AI GAMEBOOKS STORE von SASMAZ DIGITAL SERVICES. Alle Rechte vorbehalten.",
  // Legal titles
  "legal.impressum": "Impressum",
...
const tr: Partial<Translations> = {
  ...
  "footer.legal": "HUKUKİ",
  "footer.language": "DİL",
  "footer.contact": "İletişim: support@ai-gamebook.store",
  ...
  "footer.copyright": "© 2026 AI GAMEBOOKS STORE - SASMAZ DIGITAL SERVICES. Tüm hakları saklıdır.",
  // Legal titles
...
const fr: Partial<Translations> = {
  ...
  "footer.copyright": "© 2026 AI GAMEBOOKS STORE par SASMAZ DIGITAL SERVICES. Tous droits réservés.",
  // Legal titles
...
const es: Partial<Translations> = {
  ...
  "footer.copyright": "© 2026 AI GAMEBOOKS STORE por SASMAZ DIGITAL SERVICES. Todos los derechos reservados.",
...
const it: Partial<Translations> = {
  ...
  "footer.copyright": "© 2026 AI GAMEBOOKS STORE di SASMAZ DIGITAL SERVICES. Tutti i diritti riservati.",
...
const pt: Partial<Translations> = {
  ...
  "footer.copyright": "© 2026 AI GAMEBOOKS STORE por SASMAZ DIGITAL SERVICES. Todos os direitos reservados.",
