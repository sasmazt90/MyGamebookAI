              ...
              <div key={i} className="flex gap-4 p-4 bg-[#0F0A1E] rounded-xl border border-purple-900/20">
                ...
                {card.portraitUrl && card.portraitUrl.trim() ? (
                  ...
                  <div className="w-14 h-14 rounded-full bg-purple-900/40 flex items-center justify-center flex-shrink-0 border-2 border-purple-600/40">
                    <span className="text-2xl">{card.role === "protagonist" ? "ð¦¸" : card.role === "antagonist" ? "ð¦¹" : "ð¤"}</span>
                  </div>
                )}
...
function AudioToolbar({
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      {/* Volume slider â always visible */}
...
export default function Reader() {
  ...
  // Keyboard shortcut: F key toggles fullscreen  // NOTE: This useEffect MUST stay above all early returns â React error #310
  ...
  // Fairy Tale uses 360Â° rotation, others use realistic page flip
  ...
  return (
    <div ref={fullscreenRef} className="min-h-screen bg-[#0A0818] text-white flex flex-col">
      ...
      {/* Reader Header â hidden in fullscreen */}
      <div className={cn(
      ...
      {/* Two-page spread â drag/swipe container */}
      <div className="flex-1 flex items-center justify-center p-4 md:p-8 relative">
        ...
        {/* Main spread container â receives swipe/drag events */}
        ...
        >
          ...
          {/* Content */}
          {showCover ? (
            /* ââ Cover Spread âââââââââââââââââââââââââââââââââââââââââââââââ */
            <>
            ...
            /* ââ Story Pages Spread âââââââââââââââââââââââââââââââââââââââââ */
            <>
              {isComic && effectiveSpreadMode ? (
                /* ââ Comic Spread: Two pages side-by-side ââ */
                <ComicSpreadLayout
                  leftPanels={(() => {
                ...
                /* ââ Comic: ComicPageLayout with top panel + two bottom panels from panels[] ââ */
                <ComicPageLayout
                  panels={(() => {
                  ...
                  endSlot={
                    isLastPage && !hasChoices ? (
                      <div className="text-center space-y-3">
                        ...
                        <p className="text-lg font-bold text-white" style={{ fontFamily: "'Bangers', 'Impact', sans-serif" }}>â {t("reader.theEnd")} â</p>
                        <div className="space-y-3">
                ...
                /* ââ Fairy Tale: full-viewport landscape â matches reference screenshot ââ */
                <div className="shadow-2xl rounded-xl overflow-hidden w-full" style={{ background: "#0D0B1A" }}>
                  ...
                  <div className="relative w-full" style={{ aspectRatio: "16/9" }}>
                    ...
                    {/* Page number â top left overlay */}
                    ...
                    {/* Book title â top right overlay */}
                  ...
                  <div className="bg-white px-8 py-5 relative">
                    ...
                    {isLastPage && !hasChoices && (
                      <div className="mt-8 text-center space-y-4">
                        ...
                        <p className="text-lg font-bold text-[#2D1B69]">â {t("reader.theEnd")} â</p>
                        <div className="space-y-3">
                ...
                /* ââ Non-comic, non-fairy-tale: two-page portrait book spread â */
                <div className="grid grid-cols-1 md:grid-cols-2 gap-0 shadow-2xl rounded-xl overflow-hidden">
                  {/* Left page */}
              ...
              {/* Bottom nav: Prev / dots / Next â matches reference screenshot */}
