...
export default function Reader() {
  ...
  // Keyboard shortcut: F key toggles fullscreen  // NOTE: This useEffect MUST stay above all early returns — React error #310
  ...
  // Fairy Tale uses 360° rotation, others use realistic page flip
